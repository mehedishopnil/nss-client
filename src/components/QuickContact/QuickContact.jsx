...
import { FaPhone, FaEnvelope, FaMapMarkerAlt, FaClock, FaWhatsapp, FaLinkedin, FaFacebook } from 'react-icons/fa';
...
const QuickContact = () => {
    const contactMethods = [
        ...
        },
        {
            ...
            title: "Visit Us",
            info: "123 Security Ave, Safe City",
            link: "https://maps.google.com?q=123+Security+Ave",
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="mt-12 text-center">
                    <p className="text-gray-500 text-sm">
                        ...
                        <a href="tel:+8801848306085" className="text-orange-600 font-medium ml-1 hover:underline">
                            +88 01848306085
                        </a>
                    </p>
                </div>
